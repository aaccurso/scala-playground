...
object maps {
  ...
  (for(c <- char_map; o <- c._2) yield (c._1, o._2)).toList.sorted
	...
	.groupBy(_._1)                            //> res4: scala.collection.immutable.Map[Char,List[(Char, Int)]] = Map(b -> List
	...
	for {
		...
		r <- 1 until o._2 + 1
		r2 <- 1 until o2._2 + 1
	} yield List((o._1, r), (o2._1, r2))      //> res5: List[List[(Char, Int)]] = List(List((a,1), (b,1)), List((a,1), (b,2)),
                                                  //|  List((a,2), (b,1)), List((a,2), (b,2)), List((b,1), (a,1)), List((b,1), (a,
                                                  //| 2)), List((b,2), (a,1)), List((b,2), (a,2)))
  List(('a', 1)) ::: List(('b', 2))               //> res6: List[(Char, Int)] = List((a,1), (b,2))
  val o = ('a', 1)                                //> o  : (Char, Int) = (a,1)
  (for(r <- 1 until o._2 + 1) yield (o._1, r)).toList
                                                  //> res7: List[(Char, Int)] = List((a,1))
	
	combinations(List(('a',2), ('b',2)))      //> res8: List[forcomp.Anagrams.Occurrences] = List(List(), List((b,1)), List((b
